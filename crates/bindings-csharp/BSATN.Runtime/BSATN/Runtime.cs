...
public static class StringUtil
{
        ...
        foreach (var c in input)
        {
            switch (c)
            {
                ...
                default:
                    ...
                    else if (Char.GetUnicodeCategory(c) == System.Globalization.UnicodeCategory.Control)
                    {
    ...
    internal static string GenericListToString(System.Collections.IList list)
    {
        ...
        if (list.Count < 16)
        {
            ...
            {
                result.Append(GenericListToString(list));
                if (i < list.Count - 1)
                {
                    result.Append(", ");
                }
        ...
        else
        {
            ...
            result.Append("... ");
            for (var i = list.Count - 9; i < list.Count; i++)
            {
                result.Append(GenericListToString(list));
                if (i < list.Count - 1)
                {
